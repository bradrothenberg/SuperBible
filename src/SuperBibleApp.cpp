...
class SuperBibleApp : public App {
  public:
	  SuperBibleApp() :
		  paused(false),
		  time_offset(0.0f),
...
void SuperBibleApp::resize() {

	if (glViewport != NULL)
		glViewport(0, 0, getWindowWidth(),getWindowHeight());
}
void SuperBibleApp::mouseDown( MouseEvent event )
{
}

void SuperBibleApp::update()
{
}

void SuperBibleApp::draw()
{
...
void SuperBibleApp::keyDown(KeyEvent event)
{
...
CINDER_APP(SuperBibleApp, RendererGl)